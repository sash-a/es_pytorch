...
from hbaselines.envs.efficient_hrl.envs import AntMaze, HumanoidMaze, ImageAntMaze, AntFall, AntPush, AntFourRooms
...
ENV_ATTRIBUTES = {
    ...
    "highway-v0": {
        ...
        "state_indices": lambda multiagent: [
            25 * i for i in range(1 if multiagent else 10)],
        "env": lambda evaluate, render, n_levels, multiagent, shared, maddpg:
        FlowEnv(
            flow_params=highway(
                fixed_boundary=True,
    ...
    "i210-v0": {
        ...
        "state_indices": lambda multiagent: [
            25 * i for i in range(10 if multiagent else 50)],
        "env": lambda evaluate, render, n_levels, multiagent, shared, maddpg:
        FlowEnv(
            flow_params=i210(
                fixed_boundary=True,
